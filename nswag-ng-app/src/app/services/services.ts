...
export class Client extends BaseService {
    ...
    protected processAddPet(response: Response): Observable<void> {
    ...
    protected processUpdatePet(response: Response): Observable<void> {
        const status = response.status; 
        ...
        return Observable.fromPromise(this.transformOptions(options_)).flatMap(transformedOptions_ => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<Pet[]>><any>Observable.throw(e);
                }
            } else
                return <Observable<Pet[]>><any>Observable.throw(response_);
        });
    }

    protected processFindPetsByStatus(response: Response): Observable<Pet[]> {
        const status = response.status; 
        ...
        return Observable.of<Pet[]>(<any>null);
    }
    ...
    protected processFindPetsByTags(response: Response): Observable<Pet[]> {
        const status = response.status; 
    ...
    protected processGetPetById(response: Response): Observable<Pet> {
        const status = response.status; 
     ...
     */
    updatePetWithForm(petId: number, name: string, status: string): Observable<void> {
        let url_ = this.baseUrl + "/pet/{petId}";
        if (petId === undefined || petId === null)
            throw new Error("The parameter 'petId' must be defined.");
        url_ = url_.replace("{petId}", encodeURIComponent("" + petId)); 
    ...
    protected processUpdatePetWithForm(response: Response): Observable<void> {
        const status = response.status; 
     ...
     */
    deletePet(api_key: string, petId: number): Observable<void> {
        let url_ = this.baseUrl + "/pet/{petId}";
        if (petId === undefined || petId === null)
            throw new Error("The parameter 'petId' must be defined.");
        url_ = url_.replace("{petId}", encodeURIComponent("" + petId)); 
    ...
    protected processDeletePet(response: Response): Observable<void> {
        const status = response.status; 
     ...
     * @return successful operation
     */
    uploadFile(petId: number, additionalMetadata: string, file: FileParameter): Observable<ApiResponse> {
    ...
    protected processUploadFile(response: Response): Observable<ApiResponse> {
        const status = response.status; 
        ...
        return Observable.of<ApiResponse>(<any>null);
    }
    ...
    protected processGetInventory(response: Response): Observable<{ [key: string] : number; }> {
        const status = response.status; 
        ...
        return Observable.fromPromise(this.transformOptions(options_)).flatMap(transformedOptions_ => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<Order>><any>Observable.throw(e);
                }
            } else
                return <Observable<Order>><any>Observable.throw(response_);
        });
    }

    protected processPlaceOrder(response: Response): Observable<Order> {
        const status = response.status; 
        ...
        return Observable.of<Order>(<any>null);
    }
    ...
    protected processGetOrderById(response: Response): Observable<Order> {
        const status = response.status; 
    ...
    protected processDeleteOrder(response: Response): Observable<void> {
        const status = response.status; 
    ...
    protected processCreateUser(response: Response): Observable<void> {
        const status = response.status; 
    ...
    protected processCreateUsersWithArrayInput(response: Response): Observable<void> {
        const status = response.status; 
    ...
    protected processCreateUsersWithListInput(response: Response): Observable<void> {
        const status = response.status; 
    ...
    protected processLoginUser(response: Response): Observable<string> {
        const status = response.status; 
    ...
    protected processLogoutUser(response: Response): Observable<void> {
        const status = response.status; 
    ...
    protected processGetUserByName(response: Response): Observable<User> {
        const status = response.status; 
    ...
    protected processUpdateUser(response: Response): Observable<void> {
        const status = response.status; 
